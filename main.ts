...
export default class MinimalTheme extends Plugin {
  ...
  async onload() {
    ...
    const settingsUpdate = () => {
      // @ts-ignore
      const fontSize = this.app.vault.getConfig("baseFontSize") as number;
    ...
    const sidebarUpdate = () => {
      ...
      if (sidebarEl && ribbonEl && currentTheme == "moonstone" && this.settings.lightStyle == "minimal-light-contrast") {
